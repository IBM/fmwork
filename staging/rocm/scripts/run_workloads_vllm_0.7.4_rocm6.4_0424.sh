...
VLLM_USE_AITER=1 VLLM_USE_TRITON_FLASH_ATTN=0  ../fmwork_vision/driver --model_path /data/llama3.2-90b-vision-instruct --input_size 1024 --output_size 1024  --batch_size 48  --tensor_parallel_size 4  --image_width 256 --image_height 256 --kv_cache_dtype fp8  2>&1 | tee Llama-3.2-90B-Vision-tp4-bs32-aiter-kvcachefp8.txt
