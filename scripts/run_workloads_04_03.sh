...
VLLM_USE_AITER=1 VLLM_USE_TRITON_FLASH_ATTN=0 ./infer/vllm/driver --model_path /data/granite-8b-code-instruct-128k/ --input_size 1024 --output_size 1024 --tensor_parallel 1 --batch_size 128 --dtype bfloat16 --num_scheduler_steps 32 --enable_prefix_caching  --kv_cache_dtype fp8 2>&1 | tee granite-8b-code-bf16-tp1-bs128-aiter-kvcache-fp8.txt
